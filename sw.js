...
const CACHE_NAME = 'gbels-v866';  // BUILD866: fixed staff signatures (and other data saved after a large gbels_s write) vanishing in Chrome/GitHub Pages — a localStorage quota error on an early key was silently aborting the rest of save(), skipping the IndexedDB writes
