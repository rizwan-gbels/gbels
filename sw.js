...
const CACHE_NAME = 'gbels-v866';  // BUILD866: Notes Board Calendar "Reset" Day Type button now also clears the synced attDayTypes entry (and any remark) so a date truly reverts to default instead of keeping the old Holiday/Off Day styling
