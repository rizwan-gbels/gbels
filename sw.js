...
const CACHE_NAME = 'gbels-v874';  // BUILD874: silent IDB save-failure surfacing (_idbFlush now reports failed keys instead of just settling), Overdue Homework dashboard alert, Recycle Bin real 30-day auto-purge + "Expires In" countdown column
