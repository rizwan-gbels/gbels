...
const CACHE_NAME = 'gbels-v871';  // BUILD871: fixed Attendance Register print buttons not showing the Print Layout orientation dialog before printing; both attPrintRegister() and attPrintStaffRegister() now call doPrint() correctly for full print workflow
