...
const CACHE_NAME = 'gbels-v864';  // BUILD864: embedded full JSON backup dataset directly into index.html so opening on fresh device auto-populates all school data without manual import; Fee Student List export buttons + WCAG AA contrast fixes
